...
namespace appReversotask.Controllers
{
    ...
    public class ConsultaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var pacienteIdClaim = User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier)?.Value;

            if (string.IsNullOrEmpty(pacienteIdClaim) || !int.TryParse(pacienteIdClaim, out int pacienteId))
            {
        ...
        public async Task<IActionResult> Create([Bind("DataHora,StatusConsulta,MedicoId")] Consulta consulta)
        {
            // Pega o ID do paciente logado através da Session
            ...
            // Atribui automaticamente o ID do paciente logado
            ...
            ViewData["MedicoId"] = new SelectList(_context.Medicos, "Codigo", "Nome", consulta.MedicoId);
            return View(consulta);
        }
